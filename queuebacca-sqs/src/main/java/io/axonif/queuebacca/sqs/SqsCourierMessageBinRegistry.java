...
/**
 * A registry for mapping {@link MessageBin ViaMessageBins} to their corresponding SQS queues. Will also provision
...
public final class SqsCourierMessageBinRegistry {
    ...
    private static final String SQS_QUEUE_PREFIX = "axonify.sqs.queues";
    ...
    /**
     * Registers a {@link Courier ViaCourier's} processing and recycling {@link MessageBin ViaMessageBins}.
     *
