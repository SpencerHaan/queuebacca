...
public interface Client {
    ...
    /**
     * Sends a collection of {@link Message ViaMessages} to the provided {@link MessageBin} with an optional delay
     ...
     * @param delay a delay of 0 or greater
     * @param <M> the type of the message
     * @return a collection of {@link OutgoingEnvelope ViaOutgoingEnvelopes} containing information of the sent messages
     */
    ...
    /**
     * Retrieves up to the max {@link Message ViaMessages} specified from the provided {@link MessageBin}.
     *
     * @param messageBin the message bin to retrieve the messages from
     * @param maxMessages the upper limit of messages to retrieve
     * @param <M> the type of the message
     * @return zero or more {@link Message ViaMessages} up to the maximum
     */
